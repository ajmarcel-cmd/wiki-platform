...
export default async function FilePage({ params }: FilePageProps) {
  ...
  const isImage = media.majorMime === 'image'
  const isVideo = media.majorMime === 'video'
            ...
            <div className="bg-gray-50 rounded-lg border p-4 mb-6">
              {isImage && (
                <ImagePreview
                  ...
                  height={media.height}
                  size={media.byteSize}
                  uploadedBy={media.uploadedBy?.displayName}
            ...
            <div className="bg-white rounded-lg border p-6 sticky top-4">
              ...
              <dl className="space-y-3">
                ...
                {media.duration && (
                  <div>
                    ...
                    <dd className="text-sm">{formatDuration(media.duration)}</dd>
                  </div>
                )}
              ...
              <div className="mt-6 pt-4 border-t">
                ...
                <div className="bg-gray-50 p-2 rounded text-xs font-mono break-all">
                  {isImage
                    ? `![${media.displayName}](/wiki/File:${encodeURIComponent(media.filename)})`
                    : `[${media.displayName}](/wiki/File:${encodeURIComponent(media.filename)})`}
                </div>
              </div>
            </div>
